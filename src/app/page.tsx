...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-3 lg:gap-x-0 lg:pt-24 xl:gap-x-8 xl:pb-52 xl:pt-32">
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-w-6xl mx-auto px-6 lg:px-8">
