...
const ReviewGrid = () => {
  ...
  const thirdColumn = splitArray(columns[2], 2)
        ...
        <>
          <ReviewColumn
            ...
            reviewClassName={(reviewIndex) =>
              cn({
                'md:hidden':
                  reviewIndex >= firstColumn.length + thirdColumn[0].length,
          ...
          <ReviewColumn
            ...
            reviewClassName={(reviewIndex) =>
              reviewIndex >= secondColumn.length ? 'lg:hidden' : ''
            }
            msPerPixel={15}
          />
          <ReviewColumn
...
const Reviews = () => {
  return (
    <MaxWidthWrappper className="relative max-w-5xl">
      <img
